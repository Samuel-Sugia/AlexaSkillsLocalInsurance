...
public class LifeInsurance implements InsurancePolicy {
	...
	public LifeInsurance(boolean filler) {
		Random rand = new Random();
		this.policyNum = "L" + rand.nextInt(3000);
	...
	public LifeInsurance(String policyNum, String policyType, String deductible, String outOfPocket, boolean familyPlan) {
		super();
	...
	public String toString() {
		...
		builder.append("LifeInsurance [policyNum=");
