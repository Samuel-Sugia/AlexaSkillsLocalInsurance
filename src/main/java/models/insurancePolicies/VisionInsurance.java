...
public class VisionInsurance implements InsurancePolicy {
	...
	public VisionInsurance() {
	}

	public VisionInsurance(boolean filler) {
		Random rand = new Random();
		this.policyNum = "V" + rand.nextInt(3000);
		this.policyType = "Vision";
	...
	public VisionInsurance(String policyNum, String policyType, String deductible, String outOfPocket,
			boolean familyPlan) {
		super();
	...
	public boolean equals(Object obj) {
		...
		if (getClass() != obj.getClass())
			return false;
		VisionInsurance other = (VisionInsurance) obj;
		if (deductible == null) {
	...
	public String toString() {
		...
		builder.append("VisionInsurance [policyNum=");
