...
public class MedicalInsurance implements InsurancePolicy {
	...
	public MedicalInsurance(boolean filler) {
		Random rand = new Random();
		this.policyNum = "M" + rand.nextInt(3000);
	...
	public MedicalInsurance(String policyNum, String policyType, String deductible, String outOfPocket,
			boolean familyPlan) {
		super();
	...
	public String toString() {
		...
		builder.append("MedicalInsurance [policyNum=");
